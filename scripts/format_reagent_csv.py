...
# 读取原始CSV (GBK编码)
df = pd.read_csv('scripts/reagent.csv', encoding='gbk')
...
# 保存
output_df.to_csv('scripts/reagent_formatted_v3.csv', index=False, encoding='utf-8-sig')
...
# 读取原始规格来展示
original_specs = pd.read_csv('scripts/reagent.csv', encoding='gbk', usecols=['规格'])['规格']
print("\n=== 规格样例 ===")
