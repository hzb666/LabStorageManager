...
function getInventoryBorrowLabel(status: string, borrowerName: string | null): string {
  if (status === 'borrowed') {
...
const ReagentOrderExpandedRow = React.memo(function ReagentOrderExpandedRow({
  item,
}: {
  item: ReagentOrder
}) {
