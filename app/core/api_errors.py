...
class ApiErrorCode:
    ...
    CAS_MASTER_DATA_REFERENCED_BY_ORDER = "CAS_MASTER_DATA_REFERENCED_BY_ORDER"
    COMMON_PUBLIC_MASTER_DATA_REQUIRED = "COMMON_PUBLIC_MASTER_DATA_REQUIRED"
    CAS_MASTER_DATA_REQUIRED = "CAS_MASTER_DATA_REQUIRED"
